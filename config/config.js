...
const settings = {
  ...
  AUTO_SAVE_IMAGE_BILLS: process.env.AUTO_SAVE_IMAGE_BILLS ? process.env.AUTO_SAVE_IMAGE_BILLS.toLowerCase() === "true" : false,
  ...
  BASE_URL_V2: process.env.BASE_URL_V2 ? process.env.BASE_URL_V2 : "",
  REF_CODE: process.env.REF_CODE ? process.env.REF_CODE : "D1356B32CF",
  ...
  DELAY_TASK: process.env.DELAY_TASK && _isArray(process.env.DELAY_TASK) ? JSON.parse(process.env.DELAY_TASK) : [1, 15],
  AMOUNT_SCAN: process.env.AMOUNT_SCAN && _isArray(process.env.AMOUNT_SCAN) ? JSON.parse(process.env.AMOUNT_SCAN) : [1, 5],
};
